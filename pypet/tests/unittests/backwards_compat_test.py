...
class LoadOldTrajectoryTest(unittest.TestCase):
    ...
    def test_backwards_compatibility(self):
        ...
        old_pypet_traj.load(index=-1, load_data=2, force=True, filename=filename)

        self.assertTrue(old_pypet_traj.version=='0.1b.6')
        ...
        for param in old_pypet_traj.get_explored_parameters():
            self.assertTrue(old_pypet_traj.contains(param))
